      ...
      <div class="row">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                ...
                echo "<h3>Rp. ".number_format_short($total, 2)."</h3>";
              ?>
              <p>Total Sales</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT * FROM details LEFT JOIN sales ON sales.pay_id=details.sales_id LEFT JOIN products ON products.id=details.product_id WHERE sales_date=:sales_date");
...
<?php
  ...
  for( $m = 1; $m <= 12; $m++ ) {
    try{
      $stmt = $conn->prepare("SELECT * FROM details LEFT JOIN sales ON sales.pay_id=details.sales_id LEFT JOIN products ON products.id=details.product_id WHERE MONTH(sales_date)=:month AND YEAR(sales_date)=:year");
